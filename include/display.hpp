...
public:
  ...
  void show_left_and_disparity(const cv::Mat &left_gray_u8,
                               const cv::Mat &disparity_u16,
...
private:
  mutable int last_key_ =
      0; // stores last key pressed, mutable to allow updates in const methods
};
